...
import ir.sharif.math.ap98.hearthstone.gui.Buttons.BackgroundButton;
...
public class ChangeBGDrawer extends Drawer {
    private Border border;
    public ChangeBGDrawer(JPanel jPanel) {
        super(jPanel);
    }
    public void designBackgroundButtons(){
        jPanel.add(new BackgroundButton("Background1.png"));
        jPanel.add(new BackgroundButton("Background2.png"));
        jPanel.add(new BackgroundButton("Background3.JPG"));
    }
